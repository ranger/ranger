...
The date format to be display in the GUI. It defaults to "%x" which is locale's
appropriate date format. See python's strftime docs for all valid values.

=item date_plus_time_format [string]

The combined date and time format to be display in the GUI. It defaults to "%x %X"
which are locale's appropriate date and time formats.
See python's strftime docs for all valid values.
...
The time format to be display in the GUI. It defaults to "%X" which is locale's
appropriate time format. See python's strftime docs for all valid values.
