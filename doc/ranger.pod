...
[B<--force-outdated>] [B<--confdir>=I<directory>]
[B<--copy-config>=I<which>] [B<--choosefile>=I<target>]
[B<--choosefiles>=I<target>] [B<--choosedir>=I<target>]
[B<--selectfile>=I<filepath>] [B<--list-unused-keys>]
[B<--list-tagged-files>=I<tag>] [B<--profile>] [B<--cmd>=I<command>]
[I<path>]
...
=item [B<--force-outdated>]

Force ranger to run even if there are outdated config files detected.
