...
Use the preview script defined in the setting I<preview_script> to preview files?

=item use_preview_script_for_directories [bool] <zv>

Use the preview script defined in the setting I<preview_script> to preview directories?
