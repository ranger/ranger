...
=item typeahead_case_insensitive [bool]

Make type-ahead search case-insensitive?

=item typeahead_mode [bool]

Enable type-ahead navigation mode?
If enabled, the keybindings specific to type-ahead will be used in the file
browser instead of the normal ones. Alphanumeric characters as well as some
special characters as parts of file names will be used to select entries in
the file browser in a search-as-you-type manner instead of triggering
keybindings.
...
=item copytamap I<key> I<newkey> [I<newkey2> ...]
...
To copy key bindings of the console, pager, taskview or type-ahead use
"copycmap", "copypmap", "copytmap" or "copytamap" respectively.
