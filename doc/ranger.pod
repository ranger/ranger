...
Furthermore, logging to I<stderr> is enabled, unless B<--logfile> is provided,
and the log verbosity is increased.
...
=item B<--logfile>=I<targetfile>

Write log output to I<targetfile>. If "-" is specified, output is written
to I<stderr>. By default, no output is written.
