...
=item force_ignore [string]

A regular expression pattern for files which should be force hidden. 
"show_hidden" does not affect on this condition.

 set force_ignore __pycache__|.pyc$
