...
=item show_titlebar [str]

Enable / disable the titlebar. Alowed values are "true" or "false"

=item show_statusbar [str]

Enable / disable the statusbar. Allowed values are "true" or "false"
